...
class Product(models.Model):
    ...
    price_per_week = models.DecimalField(max_digits=10, decimal_places=0, null=True, blank=True)
    price_per_month = models.DecimalField(max_digits=10, decimal_places=0, null=True, blank=True)
    price_per_year = models.DecimalField(max_digits=10, decimal_places=0, null=True, blank=True)
